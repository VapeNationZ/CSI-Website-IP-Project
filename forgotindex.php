...
?>
<div class="form">
<form action="" method="post" name="login" style="background-image: url(images/black.png); padding: 2%; position: relative;top:15%;">
...
<div class="clearfix" style="background-color: white; color: #613B70">
        ...
        <div class="follow-twitter">
            <p>Computer Society of India ( CSI) is the first and largest body of computer professionals in India. It was started on 6 March 1965 by a few computer professionals and has now grown to be the national body representing computer professionals.

Through the initiatives of Professor Rangaswamy Narasimhan, the first President, CSI has been in close liaison with International Federation for Information Processing (IFIP) since its inception in 1965, when observers from India attended the IFIP Council meeting.</p>
        </div>
    </div>
